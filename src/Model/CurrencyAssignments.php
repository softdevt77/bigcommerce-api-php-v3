...
class CurrencyAssignments implements ArrayAccess
{
    ...
    public function __construct( array $data = [] )
    {
        ...
        $this->container['enabled_currencies'] = array_key_exists( 'enabled_currencies', $data ) ? $data['enabled_currencies'] : null;
        $this->container['default_currency'] = array_key_exists( 'default_currency', $data ) ? $data['default_currency'] : null;
    }
