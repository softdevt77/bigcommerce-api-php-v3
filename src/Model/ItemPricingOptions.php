...
class ItemPricingOptions implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemPricing_options';
    ...
    /**
     * Sets option_id
     * @param int $option_id The ID of the option configured for this price
     * @return $this
     */
    ...
    /**
     * Sets value_id
     * @param int $value_id The selected value ID for the configured option.
     * @return $this
     */
