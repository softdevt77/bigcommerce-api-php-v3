...
class Customer implements ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'origin_channel_id' => 'setOriginChannelId'
    ];
    ...
    protected static $getters = [
        ...
        'origin_channel_id' => 'getOriginChannelId',
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['origin_channel_id'] = array_key_exists('origin_channel_id', $data) ? $data['origin_channel_id'] : null;
    }
    ...
    {
        return $this->container['origin_channel_id'];
    }
     ...
     * @return $this
     */
    public function setOriginChannelId( $channel_id )
    {
        $this->container['origin_channel_id'] = $channel_id;
