...
class Cart1 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'customer_id' => 'int',
        'email' => 'string',
        'currency' => '\BigCommerce\Api\v3\Model\Currency1',
        'base_amount' => 'double',
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['cart_amount_inc_tax'] = array_key_exists('cart_amount_inc_tax', $data) ? $data['cart_amount_inc_tax'] : null;
        $this->container['cart_amount_ex_tax'] = array_key_exists('cart_amount_ex_tax', $data) ? $data['cart_amount_ex_tax'] : null;
    ...
    /**
     * Gets currency
     * @return \BigCommerce\Api\v3\Model\Currency1
     */
    ...
    /**
     * Sets currency
     * @param \BigCommerce\Api\v3\Model\Currency1 $currency
     * @return $this
     */
